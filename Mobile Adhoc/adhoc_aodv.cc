...
//all adhoc nodes comm with each other
...
main(int argc, char* argv[])
{
	...
	channel.AddPropagationLoss("ns3::RangePropagationLossModel", "MaxRange", DoubleValue(45.0));			//if made 0 then only tx no rcv.
...
/*
    ...
    //last node position:
	//Ptr <Node> lastNode = wifiNodes.Get (nWifi-1);
	//Ptr <MobilityModel> mm = lastNode->GetObject <MobilityModel> ();
	//mm->SetPosition (Vector (40,40,0));
